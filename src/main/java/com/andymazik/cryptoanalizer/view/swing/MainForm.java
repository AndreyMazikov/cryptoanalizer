package com.andymazik.cryptoanalizer.view.swing;
...
public class MainForm extends JFrame {
    ...
    private void run(String command, String... parameters) {
        String result = controller.doAction(command, parameters);
            loadText(result);
    ...
    private void loadText(String filename) {
        try {
            String string = Files.readString(PathBuilder.getPath(filename));
    ...
    private void setDefaultValues(JTextField... filenames) {
        for (JTextField filename : filenames) {
            ...
            filename.setText(PathBuilder.getPath(name).toString());
        }
    }
